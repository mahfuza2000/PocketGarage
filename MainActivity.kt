...
import com.example.registrationcheck.ui.theme.RegistrationCheckTheme
...
class MainActivity : ComponentActivity() { // main screen
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            RegistrationScreen() // calls the registration screen
        }
    }
}
        ...
        Box(
            ...
            Column(// create a column to display the registration form
                ...
                Button(
                    modifier = Modifier.fillMaxWidth(),
                    onClick = {
                        val isValid = ValidateAll( // validates all input fields
                        ...
                        generalError.value = if (!isValid) { // check if it did not pass all validation 
                            "Correct the highlighted errors in the form" // tell them to check and correct
                        } else {
                            ""
                        }
                    }
